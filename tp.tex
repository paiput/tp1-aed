    ...
    \begin{tcolorbox}[
        ...
        \begin{proc}{agregarBloque}{\Inout b: Berretacoin, \In transacciones: \TLista{transaccion}}{}
            ...
            \textbf{\textcolor{blue}{(}}\paraTodo[unalinea]{j}{\ent}{
                ...
                \textbf{\textcolor{red}{(}}
                (ifThenElse(existiaUsuario(B_{0}.usuarios,\ b.usuarios[i].id),\ B_{0}.usuarios[i].monto,\ 0) + montoRecibido(transacciones,\ usuarios[i],\ j) - montoGastado(transacciones,\ usuarios[i].id,\ j)) \ge 0\textbf{\textcolor{red}{)}}}\textbf{\textcolor{blue}{)}}}
            }
            \requiere{
        ...
        \begin{proc}{montoMedio}{\In b: Berretacoin}{\TLista{\float}}
        ...
        \begin{proc}{cotizacionAPesos}{\In cotizaciones: \TLista{\ent}}{\TLista{\ent}}
            ...
            \asegura{\paraTodo[unalinea]{i}{\ent}{(0 \le i < |cotizaciones|) \implicaLuego (cotizaciones[i] * montoTotalOperado(bloque.transacciones) \in res)}}
        \end{proc} \} \par
        \vspace{0.5em}
        ...
        \aux{montoTotalOperadoBloques}{bloques: \TLista{bloque}}{\ent}{
            \\ \qquad\quad \left(\sum_{k=0}^{|transacciones| - 1} montoTotalOperado(transaccionesDesde(ifThenElse(b.bloques[k].id \leq 3000, 1, 0), b.bloques[k].transacciones))\right)}
        \vspace{0.5em}

        \aux{cantTotalDeOperacionesBloques}{bloques: \TLista{bloque}}{\ent}{
            \\ \qquad\quad \left(\sum_{k=0}^{|transacciones| - 1} |b.bloques[k].transacciones| - ifThenElse(b.bloques[k].id \leq 3000, 1, 0)\right)}
        \vspace{0.5em}
