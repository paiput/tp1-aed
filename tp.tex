...
\fbox{
    \begin{minipage}{\dimexpr\textwidth-2\fboxsep-2\fboxrule}
        ...
        \begin{proc}{nuevoBerretacoin}{\In{usuarios: \TLista{usuario}}}{Berretacoin}
            ...
            \requiere{\paraTodo[unalinea]{i}{\ent}{(0 \le i < |usuarios|) \implicaLuego ((esMayorACero(usuarios[i].id\_usuario))\yLuego \lnot (hayRepetidos(usuarios,\ usuarios[i]))\yLuego (usuarios[i].cant\_berretacoin = 0))}}
        ...
        \pred{hayRepetidos}{s: \TLista{usuario}, u: usuario}{
            \qquad\quad \left(\sum_{i = 0}^{|s| - 1} ifThenElseFi(s[i].id\_usuario = u.id\_usuario, 1, 0)\right) \ge 2
        }
        \vspace{0.5em}
        % ----- esMayorACero -------------------------
        ...
        \pred{esMaximoTenedor}{s: \TLista{usuario}, u: usuario}{
            \qquad\quad \paraTodo[unalinea]{i}{\ent}{(0 \le i < |s|) \implicaLuego (u.cant\_berretacoin \ge s[i].cant\_berretacoin)}
        }
        % ---------------- AUXILIARES ---------------- %
